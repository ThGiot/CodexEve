          ...
          <div class="col-11 col-sm-10 col-xl-8">
            <div class="card border border-200 auth-card">
                  ...
                  <div class="col mx-auto">
                    ...
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href=" index.html">
                        ...
                        <p class="text-700">Inscription</p>
                      </div>
              ...
              <div class="position-relative mt-4">
                <hr class="bg-200" />
               <!-- <div class="divider-content-center">or use email</div>    onsubmit="return validerCaptcha();"  --> 
              </div>
              <form id="monFormulaire" action="sign_up_sent.php" method ="POST">
                <div class="mb-3 text-start">
                  <label class="form-label" for="name">Nom</label>
                  <input class="form-control" name="nom" id="name" type="text" placeholder="Nom" />
                </div>
                <div class="mb-3 text-start">
                  <label class="form-label" for="name">Prénom</label>
                  <input class="form-control" name="prenom" id="name" type="text" placeholder="Prénom" />
                </div>
                <div class="mb-3 text-start">
                ...
                <div class="row g-3 mb-3">
                  ...
                  <div class="col-md-6">
                  <div class="g-recaptcha" data-sitekey="6LcIFEApAAAAAPM34elE41pqMTxb68M9lnglkBjs"></div>

                  </div>
                </div>
                <div class="form-check mb-3">
                  <input class="form-check-input" name="checkCondition" id="termsService" type="checkbox" />
                  <label class="form-label fs--1 text-none" for="termsService">I accept the <a href="cgu.html">terms </a>and <a href="confid.html">privacy policy</a></label>
                </div>
                <button class="btn btn-primary w-100 mb-3">Sign up</button>
                <div class="text-center"><a class="fs--1 fw-bold" href="login.php">J'ai un compte !</a></div>
              </form>
            </div>
          </div>
        </div>
