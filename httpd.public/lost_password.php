        ...
        <div class="row flex-center position-relative min-vh-100 g-0 py-5">
          <div class="col-11 col-sm-10 col-xl-8">
            <div class="card border border-200 auth-card">
                ...
                <div class="row align-items-center gx-0 gy-7">
                  <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                    ...
                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                      <h3 class="mb-3 text-black fs-1">Récupération de mot de passe</h3>
                  ...
                  <div class="col mx-auto">
                    ...
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href=" index.html">
                        ...
                        <h3 class="text-1000">Mot de passe oublié</h3>
                        <p class="text-700"></p>
                      </div>
              ...
              <form id="monFormulaire" action="recover_sent.php" method ="POST">
                ...
                <button class="btn btn-primary w-100 mb-3">Recevoir un lien de récupération</button>
