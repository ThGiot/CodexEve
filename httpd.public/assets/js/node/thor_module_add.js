...
export function thor_module_add(param){

    const { formId,evenementId } = param;

    var myModal = new bootstrap.Modal(document.getElementById('moduleAdd'));
    myModal.show();
    document.getElementById('moduleAddOkayButton').onclick = function(){
